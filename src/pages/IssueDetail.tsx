  ...
  return (
    <div className="min-h-screen bg-[#17171a]">
      ...
      <div className="jv-container pt-28 pb-20">
        ...
        <Link
          to="/explore"
          className="inline-flex items-center gap-1.5 text-sm text-[#9f9f9f] hover:text-[#f5f5f5] transition-colors mb-6"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card-elevated p-6">
              ...
              <h1 className="jv-heading-sm text-[#f5f5f5] mb-3">
                {issue.title}
              </h1>
              ...
              <p className="text-sm text-[#9f9f9f] leading-relaxed mb-5">
                {issue.description}
              </p>
                  ...
                  return (
                    <div key={event.id} className="flex gap-3">
                      <div className="flex flex-col items-center">
                        ...
                        {!isLast && (
                          <div
                            className="w-px flex-1 mt-1 bg-white/10"
                            style={{ minHeight: 20 }}
                          />
                        )}
                      </div>
          ...
          <div className="space-y-5">
            ...
            <div className="card-elevated p-5">
              <h3 className="text-xs font-medium text-[#9f9f9f] uppercase tracking-wider mb-4">
                Current Status
              </h3>
